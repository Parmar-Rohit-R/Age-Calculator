...
const isFutureDate = (birthDetails,currentYear,currentMonth,currentDate) => {
    return(birthDetails.year > currentYear || (birthDetails.year === currentYear && (
...
const calculateAge = (birthDetails,currentYear,currentMonth,currentDate) => {
    ...
    if(currentDate < birthDetails.datee)
    {
        months--;
...
const getDaysInMonth = (month,year) => {
    ...
    const getDaysInMonth = [31, isLeapYear ? 29: 28, 31,30,31,30,31,31,30,31];
...
document.getElementById("calc-age-btn"). addEventListener("click",ageCalcute);